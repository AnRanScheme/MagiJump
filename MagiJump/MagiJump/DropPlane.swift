...
extension DropPlane {
    ...
    func update(anchor: ARPlaneAnchor) {
       ...
       planeGeometry.length = 0.01
 
        print("anchor.extent.x--------------\(CGFloat(anchor.extent.x))")
        print("anchor.extent.y--------------\(CGFloat(anchor.extent.y))")
        print("anchor.extent.z--------------\(CGFloat(anchor.extent.z))")
